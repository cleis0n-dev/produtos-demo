            ...
            <form action="{{ route('produtos_store') }}" method="POST">
                ...
                <div class="row mt-3">
                    <div class="col-12 col-sm-12 col-lg-12">
                        ...
                        <small class="text-danger">@error('produto') {{ $message }} @enderror</small><br>
                    </div>
                </div>
                <div class="row mt-2">
                    <div class="col-12 col-sm-12 col-lg-12">
                        ...
                        <small class="text-secondary">*Campo Obrigatório</small>
                        <small class="text-danger">@error('descricao') {{ $message }} @enderror</small><br>
                    </div>
                </div>
                <div class="row mt-2">
                    <div class="col-12 col-sm-12 col-lg-2">
                        ...
                        <div class="input-group mb-1">
                            ...
                            <small class="text-danger">@error('preco') {{ $message }} @enderror</small><br>
                        </div>
                        <small class="text-secondary">*Campo Obrigatório</small>
                    </div>
                </div>
