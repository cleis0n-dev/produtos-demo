...
<div class="container">
    ...
    <div class="card shadow bg-light mt-1">
        ...
        <div class="card-body">
            <form action="{{ route('produtos_update', $produtos->id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="row mt-3">
                    <div class="col-12 col-sm-12 col-lg-12">
                        <label for="produto" class="text-secondary">Produto: </label>
                        <input type="text" name="produto" value="{{ $produtos->produto }}" maxlength="80" id="" class="form-control text-secondary">
                ...
                <div class="row mt-2">
                    <div class="col-12 col-sm-12 col-lg-12">
                        ...
                        <textarea name="descricao" class="form-control text-secondary" id="" cols="10" rows="3">{{ $produtos->descricao }}</textarea>
                        <small class="text-secondary">*Campo Obrigatório</small>
                    </div>
                </div>
                <div class="row mt-2">
                    <div class="col-12 col-sm-6 col-lg-2">
                        ...
                        <div class="input-group mb-1">
                            ...
                            <input type="text" name="preco" value="{{ $produtos->preco }}" id="" class="form-control text-secondary">
                        </div>
                        <small class="text-secondary">*Campo Obrigatório</small>
                    </div>
                </div>
